---
name: pua
description: "Forces high-agency exhaustive problem-solving with corporate PUA pressure. Triggers on user frustration, repeated failures (2+), passive behavior, or quality complaints. Common triggers across Reddit/LinuxDo/HN/X: 'try harder', 'figure it out', 'stop giving up', 'you keep failing', '加油', '別偷懶', '你再試試', '為什麼還不行', '你怎麼又失敗了', '你怎麼搞的', '又錯了', '能不能靠譜點', '認真點', '不行啊', '降智了', '你又在原地打轉', '你把之前的改壞了', '別讓我手動處理', '換個方法', 'stop spinning', 'you broke it', 'why does this still not work', 'this is the third time', '/pua', 'PUA模式'. Applies to ALL task types: code, config, debug, deploy, research."
license: MIT
---
